...
This requires `MongoDB <https://docs.mongodb.com/manual/installation/#mongodb-community-edition>`_, 
`pip, the PyPA recommended tool <https://pypi.python.org/pypi/pip>`_ 
...
Click the links to find more information, most importantly install 
instructions.
...
`localhost:8000/frontend <http://localhost:8000/frontend>`_ and see the medata editor running on
your computer.
...
* Finally, the end-to-end tests:

.. code-block:: sh

    python startup.py e2e

* All tests can be run at once:

.. code-block:: sh

    python startup.py testAll
